...
This directory contains sanitized inputs for the two supported serving
configurations: GLM-5.2 EXL3 3.5-bpw and DeepSeek-V4-Flash-0731. Templates
describe contracts; they are not deployment receipts or evidence of a healthy
cluster.
