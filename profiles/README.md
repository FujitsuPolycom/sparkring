...
| Model | Quant | Layout | Context / KV* (tokens) | Status | Navigation | Quickstart |
|---|---|---|---|---|---|---|
| GLM-5.3-Flash | [NVFP4-Spark](https://huggingface.co/local-inference-lab/GLM-5.3-Flash-NVFP4-Spark) | TP4/DCP1 | 1,048,576 / [2,280,000](../performance/capacity-references.md) | Validated | recommended | [Guide](glm53-flash-spark-tp4-dcp1-sparkcache/README.md) |
...
| GLM-5.3-Flash | [NVFP4-Spark](https://huggingface.co/local-inference-lab/GLM-5.3-Flash-NVFP4-Spark) | TP4/DCP4 | 1,048,576 / [8,364,901](../performance/records/glm53-flash/r33-image020-tp4-dcp4-sparkcache-20260911.md) | Validated | alternative | [Guide](glm53-flash-spark-tp4-dcp4-sparkcache/README.md) |
