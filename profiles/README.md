...
|---|---|---|---|---|
| DCP1 | direct-pair-2 | Off | Experimental | [mimo-v26-flash-rl-tp2 (default)](../docs/operations/installer.md) |
...
| Parallelism | Network | SparkCache | Guide status | Configuration and guide |
|---|---|---|---|---|
| DCP1 | direct-cycle-4 | Off | Experimental | [mimo-v26-flash-rl-tp4 (default)](../docs/operations/installer.md) |
...
| Parallelism | Network | SparkCache | Guide status | Configuration and guide |
|---|---|---|---|---|
| DCP1 | direct-pair-2 | Off | Experimental | [glm53-flash-nvfp4-spark-tp2 (default)](../docs/operations/installer.md) |
...
| Parallelism | Network | SparkCache | Guide status | Configuration and guide |
|---|---|---|---|---|
| DCP1 | direct-cycle-4 | Off | Experimental | [glm53-flash-nvfp4-spark-tp4 (default)](../docs/operations/installer.md) |
