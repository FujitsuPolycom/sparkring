...
| Qwen3.8-Flash-Next | [NVFP4 QAD](https://huggingface.co/local-inference-lab/Qwen3.8-Flash-Next-NVFP4/tree/629bc3218833a38b475b719f34aa571666f4a03e) | vLLM | DCP1 | 262K / [3.2M](../performance/records/qwen38-flash-next/r37-shared-tp4.json) | (in dev) | Development | [Guide](../profiles/qwen38-flash-next-qad-tp4/README.md) |
...
| Parallelism | Network | SparkCache | Status | Configuration and guide |
|---|---|---|---|---|
| DCP1 | direct-cycle-4 | Off (in dev) | Development | [qwen38-flash-next-qad-tp4](../profiles/qwen38-flash-next-qad-tp4/README.md) |
