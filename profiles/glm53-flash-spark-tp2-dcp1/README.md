...
using its published R37 image and locally recorded image receipt. Select
...
The [R35 fallback](../glm53-flash-spark-tp2-dcp1-sparkcache/README.md#r35-fallback)
retains the previous image selection.
