...
def plan(
    ...
    *,
    ...
    if (
        ...
        or query.setup != _runtime_setup(runtime)
    ):
...
def _runtime_setup(runtime):
    ...
    return FrozenMapping({
        ...
        "opposite_paths": runtime._opposite_paths,
        "peer_hca_map": tuple(tuple(indices) for indices in runtime._peer_hca_map),
