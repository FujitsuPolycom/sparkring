...
initialize on this switchless topology at all (see the
[patched-NCCL fallback contract](../../../spark_transport/nccl/README.md)).
Four ranks in throwaway containers using the deployment
