...
def capture_query_rows(concurrency: int) -> tuple[int, ...]:
    """Return the specified graph buckets for a concurrency.

    C1 uses Q1/Q3/Q5 buckets. C2-C8 include exact uniform
...
def render_markdown() -> str:
    ...
    lines = [
        ...
        "",
        "<!-- Generated by performance/harnesses/vllm/decode_payload_contract.py. -->",
        "",
        ...
        "",
        "| Concurrency | Legal logical widths | Max Q | Capture buckets Q |",
        "|---:|:---|---:|:---|",
    ]
    for concurrency in range(1, MAX_CONCURRENCY + 1):
        maximum = maximum_query_rows(concurrency)
