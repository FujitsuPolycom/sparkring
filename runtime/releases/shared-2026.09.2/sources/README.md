...
selection, multimodal forwarding, the startup audit, request-ID padding
initialization and cyclic-cleanup deferral around CUDA timing gates. They contain
no model weights or deployment benchmark results.
