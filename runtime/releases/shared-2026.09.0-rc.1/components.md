...
| NCCL collective communication | Retained SparkRing-patched 2.30.7; source/build receipts and exact isolated-runtime binary hash in the [combined manifest](../../deepseek-v41-sglang/combined-image/manifest.json) | NCCL's complete license/notices remain applicable; [patch attribution](../../../THIRD_PARTY_NOTICES.md#1-nvidia-nccl-portions-included) |
