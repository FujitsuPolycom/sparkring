...
work_root=${VLLM_PACKAGE_WORK_ROOT:-$root/work/vllm-package-667ee2f6}
...
version=${VLLM_VERSION_OVERRIDE:-0.26.1rc0+sparkring.r33.667ee2f6}
expected_head=ae89131442359dc332d9c46009be3c1f8cdee0b4
expected_package_tree=667ee2f6652efa065c57a7adc0193991f6cde6ac
