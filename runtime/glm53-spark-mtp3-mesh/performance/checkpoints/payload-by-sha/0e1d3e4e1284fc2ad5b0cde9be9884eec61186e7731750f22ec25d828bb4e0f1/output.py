...
class SchedulerOutput:
    ...
    # Explicit absolute checkpoint positions, keyed by request identity. The
    # worker validates (start, end) against its actual packed query before use.
    recurrent_prefill_checkpoint_plans: dict[str, tuple[int, int, tuple[int, ...]]] | None = None
