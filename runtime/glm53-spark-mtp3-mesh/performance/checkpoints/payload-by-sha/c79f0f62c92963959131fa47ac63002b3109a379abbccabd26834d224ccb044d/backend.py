...
class CommonAttentionMetadata:
    ...
    """Current-batch-row plans: absolute start, end and checkpoint positions.
    Populated only for explicitly planned eager recurrent prefills; padding
    rows are None. Targets must refer to allocated, request-owned state slots.
    """
