...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # --- davidsyoung nvfp4/DCP overlay env vars (added for head66 graft) ---
    ...
    "VLLM_DCP_A2A_LARGE_BACKEND": lambda: os.getenv("VLLM_DCP_A2A_LARGE_BACKEND", "ag_rs"),
    "VLLM_DCP_PROJECT_BEFORE_MERGE": lambda: bool(int(os.getenv("VLLM_DCP_PROJECT_BEFORE_MERGE", "1"))),
    "VLLM_DCP_PROJECT_BEFORE_MERGE_MIN_PREFILL_TOKENS": lambda: int(os.getenv("VLLM_DCP_PROJECT_BEFORE_MERGE_MIN_PREFILL_TOKENS", "1024")),
