...
class DFlashQwen3Model(nn.Module):
    ...
    def _build_context_kv_buffers(
        ...
        try:
            ...
            # This vLLM build has no MXFP8 linear method class; no draft
            # layer can be MXFP8, so the isinstance checks below are False.
            class ModelOptMxFp8LinearMethod:  # type: ignore[no-redef]
                pass
