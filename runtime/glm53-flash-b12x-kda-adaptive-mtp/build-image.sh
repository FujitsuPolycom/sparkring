...
image="${IMAGE:-sparkring-glm53-runtime:b12x-kda-adaptive-mtp-0b67266a-arm64}"
receipt_path="${BUILD_RECEIPT:-${PWD}/glm53-flash-b12x-kda-adaptive-mtp-image-receipt.json}"
