...
the NIC-written slots with system-scope loads. Each power-of-two launch grid
uses its own staging and tail counters shared safely with all-reduce launches.
"""
