...
Status: **research-only**. Switched deployments are provided as-is. This
...
| Speculation / loader | Static native MTP3; fastsafetensors target loader |
...
that marker. The wrapper removes it on exit or failure. Other ranks use the
