...
def render_markdown() -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "```text",
            # This deliverable ships in the private archive, not this tree.
            "python spark_transport/integrations/vllm/"
            "spark_decode_payload_contract.py --check "
            "deliverables/glm52-decode-payload-contract-c1-c8.md",
            "```",
            "",
        ]
    )
