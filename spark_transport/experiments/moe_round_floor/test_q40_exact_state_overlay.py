...
from scripts import prepare_exl3_r7_sircl_tiered as sircl  # noqa: E402
from scripts.test_prepare_exl3_r7_sircl_tiered import (
    artifact_digests,
    source_profile as ckv_source_profile,
)  # noqa: E402
...
def base_profile() -> dict:
    return sircl.derive_candidate(
        ckv_source_profile(), artifact_digests=artifact_digests()
    )
