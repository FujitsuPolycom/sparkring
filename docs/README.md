...
| [Dual-port striping probe record](DUAL_PORT_STRIPING_PROBE_20260818.md) | Model-free four-rank graph-collective measurements: the fused kernel's large-payload pathology and the two mechanisms that eliminate it; research-only, with limitations stated. |
