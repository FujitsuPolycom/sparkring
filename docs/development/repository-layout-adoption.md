...
| [Qwen QAD TP4 SparkCache](../../performance/records/qwen38-flash-next/sparkcache-tp4.json) | Optional 32-token-block configuration; four-rank restore of 7,200 tokens, corrupted-object rejection with full recomputation, and original-service rollback; no media/performance claim |
