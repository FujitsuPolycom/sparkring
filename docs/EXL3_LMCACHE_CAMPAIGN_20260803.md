...
`release/v0.5.2-glm52-dcp-base`. The OCI labels of the r20 registry image
from the upstream RTX 6000 Pro inference community
(`local-inference-lab`) report base commit
