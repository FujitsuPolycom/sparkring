...
| SparkRing profile | `FujitsuPolycom/sparkring`, branch `codex/glm53-flash-sparkcache-tp4`, based on `510556275ed3b77fc56a14367d319417072eeb8c`. | No immutable commit contains the profile files. Publication is blocked until a PR and image receipt record that commit. |
