...
| openai/gpt-oss-120b | `openai/gpt-oss-120b` (no revision pinned in this repository) | 2880 | Unsupported — no serving or shadow-validation record exists in this repository; width 2880 is covered only by offline admission-surface tests | [GPT_OSS_120B.md](GPT_OSS_120B.md) |
...
| deepseek-ai/DeepSeek-V4-Flash-0731 | `deepseek-ai/DeepSeek-V4-Flash-0731` (no revision pinned in this repository) | 4096 | Research-only / unsupported — candidate with no validation record of any kind in this repository | [DEEPSEEK_V4_FLASH_0731.md](DEEPSEEK_V4_FLASH_0731.md) |
