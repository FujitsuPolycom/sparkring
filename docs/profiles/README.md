...
| GLM-5.3 Flash R8 + BF16 DFlash2 | four-Spark cycle, TP4/DCP1, DCP2, or DCP4 | Public ARM64 image; SparkCache or vLLM-only mode; one-million-depth DCP1 request and bounded DCP1/DCP2/DCP4 restart restore | [runtime](../../runtime/glm53-flash-jj-r8-gb10/README.md), [quickstart](../GLM53_JJ_R8_GB10_SPARKCACHE_TP4_QUICKSTART.md), [public image record](../../runtime/glm53-flash-jj-r8-gb10/PUBLIC_IMAGE_VALIDATION.md) |
