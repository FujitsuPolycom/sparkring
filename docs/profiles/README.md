...
| Published JJ r7-compatible GLM-5.3 Flash base | four-Spark cycle, TP4 with DCP1/DCP2/DCP4 | launcher defaults: 524,288-token limit, 16 sequences, 8,192 batched tokens. DCP2 and DCP4 completed bounded 7K-prompt live checks; throughput, concurrency, and 512K-request behavior remain unqualified. Bounded C4 smoke used DCP1, 262,144, and 4,096 | [Artifacts](../../runtime/glm53-flash-jj-r7-gb10/artifacts.json), [quickstart](../GLM53_JJ_R7_GB10_TP4_QUICKSTART.md), [smoke record](../../performance/records/glm53-flash/jj-r7-gb10-tp4-smoke-20260830.md) |
...
| Published JJ r7-compatible GLM-5.3 Flash + SparkCache | four-Spark cycle, pull-only image at TP4/DCP1 | launcher defaults: 524,288-token limit, 16 sequences, 8,192 batched tokens, and 524,288-token cache span. Bounded DCP1 C4 smoke used 262,144 and 4,096. A source overlay restored exact DCP2/DCP4 prompts after restart, but requires a replacement image | [Artifacts](../../runtime/glm53-flash-jj-r7-gb10/artifacts.json), [quickstart](../GLM53_JJ_R7_GB10_TP4_QUICKSTART.md), [DCP source-overlay evidence](../../runtime/glm53-flash-jj-r7-gb10/SPARKCACHE_DCP_SOURCE_OVERLAY.md) |
