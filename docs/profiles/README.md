...
| GLM-5.3 Flash + BF16 DFlash2 | four-Spark cycle, TP4/DCP1 | implemented 524,288-token/32-sequence cache-disabled profile; no standalone live receipt | [Recipe](../../recipes/glm53-flash-nvfp4-dflash2-bf16-tp4-dcp1.json), [quickstart](../GLM53_FLASH_DFLASH2_BF16_TP4_QUICKSTART.md), [profile record](GLM53_FLASH_DFLASH2_BF16_TP4.md) |
