...
| GLM-5.3 Flash NVFP4-Spark with MTP3 and SparkCache | four-Spark mesh, TP4/DCP1 | Bounded connector-job capture and restore profile; full shared-image recovery qualification incomplete | [Profile selection](../GLM53_TP4_PREFILL_QUICKSTART.md#prepare-the-hosts-and-image) |
