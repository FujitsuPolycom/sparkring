...
| DeepSeek-V4-Flash-0731 | `deepseek-ai/DeepSeek-V4-Flash-0731` (no revision pinned in this repository) | 4096 | Functional launch attested (operator record, 2026-08-18): loads and serves on the ring at width 4096 with an fp8 key-value cache; not shadow-qualified, no numerical or performance claim | [DEEPSEEK_V4_FLASH_0731.md](DEEPSEEK_V4_FLASH_0731.md) |
