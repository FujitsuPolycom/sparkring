...
| GLM-5.3 Flash R8 NVFP4 + BF16 DFlash2 | four-Spark cycle, TP4 with DCP1, DCP2, or DCP4 | 1M context, 16 sequences, 8,192-token batch; FP8 KV at 26 GiB/rank for DCP1 or 30 GiB/rank for DCP2/DCP4; SparkCache optional; live checks cover both cache modes and DCP1/DCP2/DCP4 restart restore | [runtime](../../runtime/glm53-flash-jj-r8-gb10/README.md), [quickstart](../GLM53_JJ_R8_GB10_SPARKCACHE_TP4_QUICKSTART.md), [public image record](../../runtime/glm53-flash-jj-r8-gb10/PUBLIC_IMAGE_VALIDATION.md) |
