...
| GLM-5.3 Flash NVFP4 + BF16 DFlash2 | four-Spark cycle, TP4 with DCP1, DCP2, or DCP4 | 1M context, 16 sequences, 8,192-token batch; FP8 KV at 26 GiB/rank for DCP1, 30 GiB/rank for DCP2, or 24 GiB/rank for DCP4; SparkCache optional; DCP4 is preferred and has recorded asynchronous publication and persistent-restore evidence; serves text only by default (image inputs implemented, not qualified; unsupported together with SparkCache in this image) | [base recipe](../../recipes/glm53-flash-nvfp4-dflash2-bf16-tp4.json), [SparkCache composition](../../recipes/sparkcache/glm53-flash-nvfp4-dflash2-bf16-tp4.json), [quickstart](../GLM53_JJ_R8_GB10_SPARKCACHE_TP4_QUICKSTART.md), [image record](../../runtime/glm53-flash-jj-r8-gb10/ASYNC_CAPTURE_IMAGE_VALIDATION.md) |
