...
The executable MTP2 profile is generated by
`scripts/prepare_exl3_r7_mtp2.py` from the corrected stock-DCP4 R7 control;
the generator also emits a byte-identical rollback profile.
