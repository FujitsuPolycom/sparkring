...
| `glm53-flash-nvfp4-spark-tp2`, `glm53-flash-nvfp4-spark-tp4` | GLM-5.3-Flash NVFP4-Spark, revision `a608241037e4`, with MTP3 | **Development** (`implemented`): installed on this image on one pair and one four-Spark ring, adopting checkpoint copies on the Sparks; counting, arithmetic and code checks passed ([record](../../performance/records/images/dev-20260925-qwendecode-installer-profiles-20260926.md)). Serving is not qualified. |
| `mimo-v26-flash-rl-tp2`, `mimo-v26-flash-rl-tp4` | MiMo-V2.6-Flash-RL, revision `5711b2681699`, with DFlash5 | **Development** (`implemented`): as for GLM ([record](../../performance/records/images/dev-20260925-qwendecode-installer-profiles-20260926.md)). |
