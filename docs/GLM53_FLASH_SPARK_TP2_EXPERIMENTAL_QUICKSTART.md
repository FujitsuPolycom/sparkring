...
Use the [canonical NVFP4-Spark TP2 guide](../runtime/profiles/glm53-flash-spark-tp2/README.md)
...
The previous 5 GiB adaptive-MTP profile and its image are preserved in
...
remain historical evidence; they do not qualify the guarded shared image.
