...
the [persistent SIRCL rail procedure](../architecture/sircl.md#persistent-host-rail-configuration)
...
[Profile validation: performance, accuracy, and restart checks](../operations/profile-validation.md).
