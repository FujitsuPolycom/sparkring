...
This index preserves source-composition and rollback details from the repository
before profile-based navigation. It does not recommend a deployment. Use the
[profile catalog](../../profiles/README.md) for deployment selection.
...
| Path | Role |
|---|---|
| [`exl3-r7/`](../../runtime/exl3-r7/README.md) | GLM-5.2 EXL3 3.5-bpw R7 ARM64 image builder and its verification tests |
| [`glm53-flash/`](../../runtime/glm53-flash/README.md) | GLM-5.3 Flash target, BF16 DFlash2, vLLM, B12X, patched NCCL, and SparkCache identity and attestation contract |
| [`glm53-flash-jj-r8-gb10/`](../../runtime/glm53-flash-jj-r8-gb10/README.md) | GLM-5.3 Flash ARM64 image builder and adjustable TP4/DCP1/DCP2/DCP4 launcher with optional SparkCache; the preferred DCP4 path uses the embedded, four-rank-qualified dual-rail SIRCL bundle with patched NCCL fallback |
| [`glm53-spark-mtp3-mesh/`](../../runtime/glm53-spark-mtp3-mesh/README.md) | Research-only NVFP4-Spark native-MTP3 profile, verified SIRCL/RoCEnante bundle, supervised hardware-forwarded mesh plan, and optional local image packaging |
| [`glm53-flash-e10536a/`](../../runtime/glm53-flash-e10536a/README.md) | Implemented source builder for vLLM e10536a with internal MTP5 and opt-in adaptive depth; live serving unqualified |
| [`glm53-flash-b12x-kda-adaptive-mtp/`](../../runtime/glm53-flash-b12x-kda-adaptive-mtp/README.md) | Implemented source builder for adaptive MTP and live-tensor B12X KDA at vLLM `0b67266a`; live serving unqualified |
| [`deepseek0731-gb10/`](../../runtime/deepseek0731-gb10/README.md) | DeepSeek-V4-Flash-0731 GB10 parser, K5 sparse-row, and native PR431 image layer |
| [`qwen38/`](../../runtime/qwen38/README.md) | Public-source ARM64 image builder for the Qwen3.8-27B EXL3 K5/K6 pair and cycle profiles |
| [`faststart-lock.json`](../../runtime/faststart-lock.json) | Immutable ARM64 base-image and model-identity pins |
| [`build-public-overlay.py`](../../runtime/build-public-overlay.py) | Builds the reviewed Python overlay bundle |
| [`public-overlay-files.json`](../../runtime/public-overlay-files.json) | Explicit source-file allowlist for the public overlay |
| [`test_public_overlay.py`](../../runtime/test_public_overlay.py) | Offline contract coverage for allowlisting and manifest generation |
...
The directory's [`pins.json`](../../runtime/glm53-flash-jj-r8-gb10/pins.json) records the
...
[`runtime/exl3-r7/`](../../runtime/exl3-r7/README.md) is the supported builder for the
...
[`runtime/qwen38/`](../../runtime/qwen38/README.md) builds the Qwen runtime from public,
...
[`runtime/glm53-flash/`](../../runtime/glm53-flash/README.md) builds the source-pinned
...
[`runtime/deepseek0731-gb10/`](../../runtime/deepseek0731-gb10/README.md) builds the
